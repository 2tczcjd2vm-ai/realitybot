...
def upgrade_blok(pocet):
    ...
    return (
        ...
        'Bezplatná verze ukazuje byty s denním zpožděním. U bytu výrazně pod cenou je přitom '
        'jeden den hodně — ten, kdo volá makléři první, si vybírá, ostatní se řadí do fronty.</p>'
